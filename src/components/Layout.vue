        ...
        <v-container>
          <v-row>
            ...
            <div class="route-links">
              <router-link
                v-if="isLoggedIn"
                class="route-link pl-5"
                :to="{ name: 'user-list' }"
                >Users</router-link
              >
              <router-link class="route-link pl-5" :to="{ name: 'post-list' }"
                >Posts</router-link
              >
            </div>
            <v-spacer></v-spacer>
            ...
            <div class="route-links">
              ...
              <router-link class="route-link" :to="{ name: 'login' }" v-if="!isLoggedIn"
                >Login</router-link
              >
              <router-link
                v-if="!isLoggedIn"
                class="route-link pt-3"
                :to="{ name: 'create-user' }"
